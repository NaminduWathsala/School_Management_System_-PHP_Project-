...
?>
    ...
    <head>
        ...
        <title>Register a Academic Officer - Admin</title>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Register a new Academic Officer </h1>
                        </div>
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <form>
                                            ...
                                            <div class="my-4   d-block ">
                                                <a class="btn btn-primary col-12 col-lg-10" onclick="registerAcademicOfficer();">Register Teacher & Send Verification code</a>
                                            </div>
                                        </form>
                                    </div>
