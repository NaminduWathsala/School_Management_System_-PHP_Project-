                            ...
                            <div class="col-12 col-lg-4 mb-4">
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        $profileimg = Database::search("SELECT * FROM `profile_img` WHERE `user_email` = '" . $_SESSION["ao"]["email"] . "' ");
                                        ...
                                        ?>
                                        <br>
                                        <span class="font-weight-bold"><?php echo $_SESSION["ao"]["fname"] . " " . $_SESSION["ao"]["lname"]; ?></span>
                                        <br>
                                        <span class="text-black-50"><?php echo $_SESSION["ao"]["email"]; ?></span>
                                        <br>
                            ...
                            <div class="col-12 col-lg-8 mb-4">
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        $urs = Database::search("SELECT * FROM `academic_officer` WHERE `email` = '" . $_SESSION["ao"]["email"] . "'");
                                        $un = $urs->num_rows;
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <input id="email" class="form-control" type="text" placeholder="Enter Email Id" readonly value="<?php echo $_SESSION["ao"]["email"]; ?>" />
                                            </div>

                                            <div class="col-md-12 mb-3">
                                                <label class="form-label">Password</label>
                                                <input id="password" class="form-control" type="text" placeholder="Enter Password" readonly value="<?php echo $_SESSION["ao"]["password"]; ?>" />
                                            </div>

                                            <?php

                                            $ql = Database::search("SELECT * FROM `teacher_qualifications` WHERE `id`='" . $_SESSION["ao"]["teacher_qualifications_id"] . "' ");
                                            $qli = $ql->fetch_assoc();
                                            ?>
                                            ...
                                            $username = $_SESSION["ao"]["email"];
                                            $saddressrs = Database::search("SELECT * FROM `academic_officer` WHERE `address_id` = '1' AND `email`= '" . $_SESSION["ao"]["email"] . "' ");
                                            $n = $saddressrs->num_rows;

                                            if ($n == 0) {
                                                $tadds = Database::search("SELECT * FROM `academic_officer` INNER JOIN `address` ON `academic_officer`.`address_id` = `address`.`id` WHERE `academic_officer`.`id` = '" . $_SESSION["ao"]["id"] . "'");
                                        ...
                                        <div class="mt-5 text-center">
                                            <button class="btn btn-primary" onclick="updateAcademicOfficerprofile();">Update Profile</button>
                                        </div>
