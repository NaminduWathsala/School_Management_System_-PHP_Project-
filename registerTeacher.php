...
?>
    ...
    <head>
        ...
        <title>Register a Teacher - Admin</title>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Register a new Teacher</h1>
                        </div>
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <form>
                                            ...
                                            <div class="mb-3 col-12 col-lg-5 d-inline-block">
                                                ...
                                                <input id="nic" type="text" class="form-control" id="exampleInputPassword1">
                                            </div>
                                            <div class="mb-3 col-12 col-lg-5 d-inline-block">
                                            ...
                                            <div class="mb-3 col-12 col-lg-10 d-inline-block">
                                                ...
                                                <textarea class="form-control" cols="100%" rows="10" id="quli"></textarea>
                                            </div>
                                            ...
                                            <div class="mb-3 col-12 col-lg-5 d-inline-block">
                                                ...
                                                <select id="grade" class="form-select text-black-50">
                                                    ...
                                                    $rs2 = Database::search("SELECT * FROM `teachers_grade`");
                                                    $n2 = $rs2->num_rows;

                                                    for ($i = 1; $i <= $n2; $i++) {
                                                        $grade = $rs2->fetch_assoc();
                                            ...
                                            <div class="mb-3 col-12 col-lg-5 d-inline-block">
                                                ...
                                                <select id="sub" class="form-select text-black-50">
                                                    <option value="0">Select</option>
                                                    <?php

                                                    $rs3 = Database::search("SELECT * FROM `teachers_subject`");
                                                    $n3 = $rs3->num_rows;
                                            ...
                                            <div class="my-4   d-block ">
                                                <a class="btn btn-primary col-12 col-lg-10" onclick="registerTecher();">Register Teacher & Send Verification code</a>
                                            </div>
                                        </form>
                                    </div>
