        ...
        <div class="row align-content-center">
            ...
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="col-12">
                        <p class="text-center title1">Hi, Welcome To Maris Stella College Teachers</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 pt-2 pb-4 ps-5 pe-5">
                <div class="row">
                    <div class="col-6 d-none d-lg-block background2" style="height: 330px;"></div>
                    ...
                    <div class="col-12 col-lg-6 d-block">
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-lg-6 d-grid">
                                <button class="btn btn-primary" type="button" data-bs-toggle="modal" id="adminemail" data-bs-target="#exampleModal" onclick="teacherSignIn();">Log In</button>
                            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary" onclick=" teacherSignInWithVerification();">Verify</button>
                        </div>
                    </div>
                </div>
            </div>
